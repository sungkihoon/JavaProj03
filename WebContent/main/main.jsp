...
<script src="../bootstrap4.4.1/jquery/jquery-3.5.0.js"></script>
<script>
	$(function() {
		//메인페이지를 로드할때 현재월 출력하는 달력 가져오기
	...
	<center>
		...
		<div id="wrap">
			...
			<div class="main_contents">
				...
				<div class="main_con_left">
							...
							<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
									...
									<td><input type="text" name="id"
										value="<%=(user == null) ? "" : user%>" class="login_input"
										tabindex="1" /></td>
									<td rowspan="2"><input type="image"
										src="../images/login_btn01.gif" alt="로그인" tabindex="4" /></td>
								</tr>
								<tr>
									<th><img src="../images/login_tit02.gif" alt="패스워드" /></th>
									<td><input type="password" name="pass" value=""
										class="login_input" tabindex="2" /></td>
								</tr>
							</table>
							<p>
					...
					<p style="padding: 10px 0px 10px 10px">
						<span style="font-weight: bold; color: #333;"> <%=session.getAttribute("name")%>님,
						</span> 반갑습니다.<br />로그인 하셨습니다.
					</p>
				...
				<div class="main_con_center">
					<p class="main_title">
						<img src="../images/main_title02.gif" alt="공지사항 NOTICE" /><a
							href="../space/board_list.jsp?bname=notice"><img
				...
				<div class="main_con_right">
					<p class="main_title">
						<img src="../images/main_title03.gif" alt="자유게시판 FREE BOARD" /><a
							href="../space/board_list.jsp?bname=freeboard"><img
							src="../images/more.gif" alt="more" class="more_btn" /></a>
					</p>
					<ul class="main_board_list">
						<li><p>
			...
			<div class="main_contents">
				...
				<div class="main_con_left">
					<p class="main_title">
						<img src="../images/main_title04.gif" alt="연락처  CONTACT" />
					</p>
				...
				<div class="main_con_right">
					<p class="main_title">
						<img src="../images/main_title06.gif" alt="사진게시판 PHOTO BOARD" /><a
							href="../space/board_list.jsp?bname=photoboard"><img
							src="../images/more.gif" alt="more" class="more_btn" /></a>
					</p>
